...
%description libs
This package provides the artiqoxconsensus shared libraries. These libraries
...
artiqoxconsensus shared library. If you are developing or compiling software
