...
#   c) node1 mines 61 blocks, so now nodes 0 and 1 have 500.000 aiq, node2 has none. 
#   d) node0 sends 210.000 aiq to node2, in two transactions (110.000 aiq, then 100.000 aiq).
...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210.000 AIQ from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1.000.000 aiq in block rewards plus fees, but
        ...
        # Send 100000 AIQ with subtract fee from amount
