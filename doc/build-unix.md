UNIX BUILD NOTES
====================
Some notes on how to build Indocoin in Unix. 
...
This will build indocoin-qt as well if the dependencies are met.
...
If you want to build Indocoin-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a indocoin-qt executable will be
built by default.

Notes
-----
The release is built with GCC and then "strip indocoind" to strip the debug
