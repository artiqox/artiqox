...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("multiaiq.org", "seed.multiaiq.org"));
        vSeeds.push_back(CDNSSeedData("multiaiq.org", "seed2.multiaiq.org"));
        vSeeds.push_back(CDNSSeedData("aiqr.artiqox.com", "seed.aiqr.artiqox.com"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testaiq.lionservers.de", "testaiq-seed.lionservers.de"));
        vSeeds.push_back(CDNSSeedData("lionservers.de", "testaiq-seed-static.lionservers.de"));
