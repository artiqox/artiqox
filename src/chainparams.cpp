...
public:
    CMainParams() {
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1399728188;
        genesis.nBits    = 0x1e0ffff0;
        genesis.nNonce   = 674115;
        ...
        std::vector<unsigned char> pka = list_of(38);
...
public:
    CTestNetParams() {
        ...
        genesis.nTime = 1516704604;
        genesis.nNonce = 2146448;
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x8c4cf624fc00d9d9dedee96f3baf1ba5874390ac30e7e3de393a0efc5209d42d"));
...
public:
    CRegTestParams() {
        ...
        genesis.nTime = 1516709914;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 3514306;
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 18444;
        strDataDir = "regtest";
        assert(hashGenesisBlock == uint256("0x899270eae5e92d007144c455081e8dcf381acb5f2b2deb44e305b824e7330cd0"));
