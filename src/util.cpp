...
const char * const BITCOIN_CONF_FILENAME = "artiqox.conf";
const char * const BITCOIN_PID_FILENAME = "artiqoxd.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Artiqox";
#else
    // Unix
