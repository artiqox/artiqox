...
const char* BIP71_MIMETYPE_PAYMENT = "application/artiqox-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/artiqox-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/artiqox-paymentrequest";
