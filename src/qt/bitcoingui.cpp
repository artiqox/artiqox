...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/about"), tr("&About Artiqox Core"), this);
    aboutAction->setStatusTip(tr("Show information about Artiqox Core"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Artiqox Core client") + " " + networkStyle->getTitleAddText();
