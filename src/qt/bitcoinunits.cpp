...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MBTC: return QString("Mega-Artiqox (1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    case kBTC: return QString("Kilo-Artiqox (1" THIN_SP_UTF8 "000)");
