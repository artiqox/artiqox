    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    int titleCopyrightVSpaceAIQ = 40;
    ...
    QString titleText       = tr("Artiqox Core");
    ...
    QString copyrightTextAIQ  = QChar(0xA9)+QString(" 2018-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Artiqox Core developers"));
    ...
    pixPaint.setFont(QFont(font, 10*fontFactor));
    pixPaint.drawText(pixmap.width()/devicePixelRatio-titleTextWidth-paddingRight,paddingTop+titleCopyrightVSpaceAIQ,copyrightTextAIQ);
