...
void PaperWalletDialog::on_printButton_clicked()
{
    ...
    while( true ) {
        ...
        double amountInput = QInputDialog::getDouble(this, tr("Load Paper Wallets"), tr("Please wait for wallets to print and verify readability.<br/>Enter the number of AIQ you wish to send to each wallet:"), 0, 0, 2147483647, 8, &ok);
