...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Artiqox Core artiqox-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  artiqox-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded artiqox transaction") + "\n" +
              "  artiqox-tx [options] -create [commands]   " + _("Create hex-encoded artiqox transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded artiqox transaction
