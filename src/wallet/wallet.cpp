 ...
 */
CFeeRate CWallet::minTxFee = CFeeRate(COIN / 2);
...
{
    // Artiqox: Round TX bytes up to the next 1,000 bytes
    ...
    if (nFeeNeeded == 0) {
        ...
        // Artiqox: Add an increased fee for each dust output
        nFeeNeeded += GetArtiqoxDustFee(tx.vout, minTxFee);
    }
